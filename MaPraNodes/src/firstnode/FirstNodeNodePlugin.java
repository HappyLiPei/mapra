 ...
 * @author 
 */
public class FirstNodeNodePlugin extends Plugin {
    // The shared instance.
    private static FirstNodeNodePlugin plugin;

    /**
     * The constructor.
     */
    public FirstNodeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FirstNodeNodePlugin getDefault() {
        return plugin;
    }
