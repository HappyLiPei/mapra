...
public class TestFileUtilities {
	...
	public void TestQueryParser() {
		LinkedList<Integer> q = FileUtilities.readInQuery("../TestData/Queries/query1.txt");
	...
	public void TestKszParserWithFrequency(){
		HashMap<Integer,LinkedList<String[]>> k = FileUtilities.readInKSZFrequency
	...
	public void TestMatrixParser(){
		String [][] m = FileUtilities.readInMatrix("../TestData/Clustering/allAgainstAll_avg.txt");
